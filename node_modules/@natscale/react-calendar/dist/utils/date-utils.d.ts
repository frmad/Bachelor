 ...
 */
export declare function addDays(date: Date, numberOfDaysToAdd: number): {
    endDate: Date;
};
/**
...
export declare function getAsNewDate(date: Date): Date;
...
export declare function numDifference(range: [Date, Date]): number;
/**
