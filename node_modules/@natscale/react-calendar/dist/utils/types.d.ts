...
declare type CommonProps = Required<Pick<CalendarProps, 'monthsLabel' | 'weekDaysLabel' | 'lockView' | 'isDisabled' | 'noPadRangeCell' | 'weekends' | 'fixedRange' | 'startOfWeek' | 'fontSize' | 'size' | 'hideAdjacentDates' | 'useDarkMode' | 'showDualCalendar' | 'className'>> & Pick<CalendarProps, 'isHighlight' | 'onEachMultiSelect' | 'onPartialRangeSelect' | 'onChange' | 'initialView'>;
